...
class UsuariosController extends AppComponent {
    ...
    public function visualizar() {
        ...
        $acoes = [
            ['controller' => 'usuarios', 'action' => 'atualizar', 'cmp' => 'iduser', 'icon' => 'fa fa-pen'],
            ['controller' => 'usuarios', 'action' => 'deletar', 'cmp' => 'iduser', 'icon' => 'fa fa-trash'],
        ];
    ...
    public function atualizar($idUsuario) {
        ...
        $strQuery = $this->Usuarios->sqlUsuarios();
        $strQuery .= " WHERE idUser = :idUser ";
        $strBind = [':idUser' => $codUser];
    ...
    public function deletar($idUsuario) {
        ...
        if(!is_null($codUser) || !empty($codUser)) {
            ...
            $strQuery = " DELETE FROM usuarios WHERE idUser = :idUsuario ";
